...
class _CartPageState extends State<CartPage> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return Scaffold(
        backgroundColor: cartController.cartList.isEmpty ? kWhite : kGreyLight,
        appBar: AppBar(
          title: const Text('Shopping'),
        ),
        body: shopInfoController.isShopInfoLoading.value
          ...
          child: Container(
            ...
            child: Row(
              children: [
                Text(
                  'Total',
                  style: context.titleMedium(color: kGrey),
                ),
                const Spacer(),
                Text(
                  '${AppConstants.currencySymbol} ${cartController.totalCartAmount}',
                  style: context.titleLarge(color: kGrey),
                ),
